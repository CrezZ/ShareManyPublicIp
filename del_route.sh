...
ip rule del from 188.120.246.128/20 dev ens3 table 1000
...
ip rule del from 188.120.246.127/20 dev ens3 table 1001
...
ip rule del from 188.120.246.126/20 dev ens3 table 1002
...
ip rule del from 188.120.246.124/20 dev ens3 table 1003
ip rule del from 192.168.252.8 table 1003 
ip route del default via 188.120.239.254 dev ens3 table 1003 
...
ip rule del from 188.120.246.121/20 dev ens3 table 1004
ip rule del from 192.168.252.9 table 1004 
ip route del default via 188.120.239.254 dev ens3 table 1004 
...
ip rule del from 188.120.241.155/20 dev ens3 table 1005
ip rule del from 192.168.252.10 table 1005 
ip route del default via 188.120.239.254 dev ens3 table 1005 
...
ip rule del from 188.120.241.154/20 dev ens3 table 1006
ip rule del from 192.168.252.11 table 1006 
ip route del default via 188.120.239.254 dev ens3 table 1006 
...
ip rule del from 188.120.241.145/20 dev ens3 table 1007
ip rule del from 192.168.252.12 table 1007 
ip route del default via 188.120.239.254 dev ens3 table 1007 
...
ip rule del from 188.120.241.141/20 dev ens3 table 1008
...
ip rule del from 188.120.241.137/20 dev ens3 table 1009
...
ip rule del from 188.120.241.136/20 dev ens3 table 1010
...
ip rule del from 188.120.241.132/20 dev ens3 table 1011
...
ip rule del from 188.120.241.120/20 dev ens3 table 1012
...
ip rule del from 188.120.239.91/20 dev ens3 table 1013
...
ip rule del from 188.120.238.41/20 dev ens3 table 1014
ip rule del from 192.168.252.19 table 1014 
ip route del default via 188.120.239.254 dev ens3 table 1014 
...
ip rule del from 188.120.233.16/20 dev ens3 table 1015
ip rule del from 192.168.252.20 table 1015 
ip route del default via 188.120.239.254 dev ens3 table 1015 
...
ip rule del from 188.120.229.117/20 dev ens3 table 1016
ip rule del from 192.168.252.21 table 1016 
ip route del default via 188.120.239.254 dev ens3 table 1016 
...
ip rule del from 188.120.227.150/20 dev ens3 table 1017
ip rule del from 192.168.252.22 table 1017 
ip route del default via 188.120.239.254 dev ens3 table 1017 
...
ip rule del from 188.120.227.83/20 dev ens3 table 1018
ip rule del from 192.168.252.23 table 1018 
ip route del default via 188.120.239.254 dev ens3 table 1018 
...
ip rule del from 188.120.225.133/20 dev ens3 table 1019
ip rule del from 192.168.252.24 table 1019 
ip route del default via 188.120.239.254 dev ens3 table 1019 
